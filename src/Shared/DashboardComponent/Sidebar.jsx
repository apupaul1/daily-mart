...
import { FaUsers, FaClipboardList, FaBullhorn, FaShoppingCart, FaPlus, FaListAlt, FaChartLine, FaTools } from 'react-icons/fa';
...
const navItems = [
    ...
    { label: 'Add Product', path: '/add-product', icon: <FaPlus /> },
...
const Sidebar = () => {
    return (
        <div className="min-h-screen bg-white shadow-md p-4 flex flex-col">
            {/* Logo */}
            <div className="flex items-center justify-center mb-6">
                <img src="https://themesbrand.com/ubold/layouts/assets/images/logo-sm.png" alt="Logo" className="w-6 h-6 mr-2" />
                <h1 className="text-lg font-bold text-gray-900">UBOLD</h1>
            </div>

            {/* Profile */}
            <div className="text-center mb-6">
                <img src="https://bootdey.com/img/Content/avatar/avatar6.png" alt="Avatar" className="w-16 h-16 rounded-full mx-auto mb-2" />
                <h2 className="text-sm font-semibold text-gray-800">Geneva Kennedy</h2>
